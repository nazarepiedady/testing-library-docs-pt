...
[`CLI Testing Library`](https://github.com/crutchcorn/cli-testing-library) is a companion library to `Testing Library` that aims to mimic the API of `Testing Library` for testing CLI applications.
...
Check out [CLI Testing Library's documentation](https://github.com/crutchcorn/cli-testing-library) for a full list of its API.
