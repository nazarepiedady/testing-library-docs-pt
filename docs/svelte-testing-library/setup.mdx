...
We're using `jdom` here as the test environment, but you can use any other options e.g `happy-dom`.
...
2. To compile the Svelte components before using them in Vitest, you need to install [@sveltejs/vite-plugin-svelte](https://github.com/sveltejs/vite-plugin-svelte) and Vite
...
4. Optionally install [vitest-dom](https://github.com/chaance/vitest-dom) to add handy assertions to Vitest
