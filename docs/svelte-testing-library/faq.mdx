...
Yes, it does. It requires the same [setup](setup.mdx) as a "normal" Svelte project.
...
See [svelte-testing-library's issue 219](https://github.com/testing-library/svelte-testing-library/issues/219) for more details.
