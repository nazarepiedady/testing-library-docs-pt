...
The [dom-testing-library Async API](dom-testing-library/api-async.mdx) is re-exported from React Testing Library.
...
- **act** wrapper around [react-dom/test-utils act](https://reactjs.org/docs/test-utils.html#act);
...
See [Querying Within Elements](dom-testing-library/api-within.mdx), [Config API](dom-testing-library/api-configuration.mdx), [Cleanup](react-testing-library/api.mdx#cleanup),
...
- **cleanup** clears the DOM ([use with `afterEach`](react-testing-library/api.mdx#cleanup) to reset DOM between tests)
