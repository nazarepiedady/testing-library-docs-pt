...
📝 If you'd love to learn more, checkout [this explanation](https://github.com/threepointone/react-act-examples/blob/master/sync.md). Even though it's for React, it gives you an idea of why it's needed.

## `fireEvent`

Passes it to the @testing-library/dom [fireEvent](dom-testing-library/api-events.mdx). It's also wrapped in `act` so you don't need to worry about doing it.
