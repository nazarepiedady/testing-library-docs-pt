...
> This library is built on top of [`DOM Testing Library`](dom-testing-library/intro.mdx) which is where most of the logic behind the queries is.
...
See the [Dom introduction][dom-solution-explainer] and [React introduction][react-solution-explainer] for a more in-depth explanation.
...
We recommend Jest as our preference. You can checkout [Using Without Jest](react-testing-library/setup.mdx#using-without-jest) if you're looking to use another framework.
